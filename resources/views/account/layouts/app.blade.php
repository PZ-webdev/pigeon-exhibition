...
<head>
    ...
    <title>@yield('title') Panel Zarządzania</title>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Potwierdź chęć opuszczenia serwisu.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Zamknij</button>
                    <a class="btn btn-primary" href="{{asset('/logout')}}">Wyloguj</a>
                </div>
            </div>
        </div>
    </div>
